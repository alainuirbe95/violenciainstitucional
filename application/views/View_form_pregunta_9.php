              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 9 </h4>

                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) le han dicho piropos groseros u ofensivos de tipo sexual o sobre su cuerpo?
                    ...
                    <?php echo form_label('9.1) ¿Dónde sucedió que alguien la haya dicho piropos groseros u ofensivos de tipo sexual o sobre su cuerpo? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="9_1[]" id="9_1">
                    ...
                    <?php echo form_label('9.2) ¿Dónde sucedió que alguien la haya dicho piropos groseros u ofensivos de tipo sexual o sobre su cuerpo? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="9_2[]" id="9_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('9.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya dicho piropos groseros u ofensivos de tipo sexual o sobre su cuerpo desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="9_3[]" id="9_3">
