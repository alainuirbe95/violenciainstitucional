              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 13 </h4>

                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) le ha enviado mensajes o publicado comentarios con insinuaciones sexuales, insultos u ofensas a través de celular, correo electrónico o redes sociales (como Facebook, Twitter, WhatsApp)?
                    ...
                    <?php echo form_label('13.1) ¿Qué personas de la siguiente lista le ha enviado mensajes o publicado comentarios con insinuaciones sexuales, insultos u ofensas a través de celular, correo electrónico o redes sociales (como Facebook, Twitter, WhatsApp)? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="13_1[]" id="13_1">
                    ...
                    <?php echo form_label('13.2) ¿Dónde sucedió que alguien le haya enviado mensajes o publicado comentarios con insinuaciones sexuales, insultos u ofensas a través de celular, correo electrónico o redes sociales (como Facebook, Twitter, WhatsApp)? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="13_2[]" id="13_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('13.3) ¿Con qué frecuencia le ha ocurrido que alguien le haya enviado mensajes o publicado comentarios con insinuaciones sexuales, insultos u ofensas a través de celular, correo electrónico o redes sociales (como Facebook, Twitter, WhatsApp) desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="13_3[]" id="13_3">
