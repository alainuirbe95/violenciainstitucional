              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
                    ...
                    <?php echo form_label('10.1) ¿Qué personas de la siguiente lista la    han manoseado, tocado, besado o se le han arrimado, recargado o encimado sin su consentimiento? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="10_1[]" id="10_1">
                    ...
                    <?php echo form_label('10.2) ¿Dónde sucedió que alguien la haya manoseado, tocado, besado o se le haya arrimado, recargado o encimado sin su consentimiento? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="10_2[]" id="10_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('10.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya manoseado, tocado, besado o se le haya arrimado, recargado o encimado sin su consentimiento desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="10_3[]" id="10_3">
