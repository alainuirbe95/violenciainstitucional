              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 15 </h4>

                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) la han vigilado o seguido al salir de la escuela?
                    ...
                    <?php echo form_label('15.1)  ¿Qué personas de la siguiente lista la han vigilado o seguido al salir de la escuela? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="15_1[]" id="15_1">
                    ...
                    <?php echo form_label('15.2) ¿Dónde sucedió que alguien la haya vigilado o seguido al salir de la escuela? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="15_2[]" id="15_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('15.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya vigilado o seguido al salir de la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="15_3[]" id="15_3">
