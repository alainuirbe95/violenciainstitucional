              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 14 </h4>

                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) le han hecho comentarios ofensivos acerca de que las mujeres no deberían estudiar?
                    ...
                    <?php echo form_label('14.1) Si la respuesta a la pregunta 14 fue afirmativa, ¿Qué personas de la siguiente lista le han hecho comentarios ofensivos acerca de que las mujeres no deberían estudiar? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="14_1[]" id="14_1">
                    ...
                    <?php echo form_label('14.2) Si la respuesta a la pregunta 14 fue afirmativa, ¿Dónde sucedió que alguien le haya hecho comentarios ofensivos acerca de que las mujeres no deberían estudiar? (señale la casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="14_2[]" id="14_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('14.3) ¿¿Con qué frecuencia le ha ocurrido que alguien le haya hecho comentarios ofensivos acerca de que las mujeres no deberían estudiar desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="14_3[]" id="14_3">
