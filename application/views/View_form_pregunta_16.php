              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 16 </h4>

                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) la castigaron, trataron mal o se vengaron, porque se negó a tener relaciones sexuales (la reprobaron, le bajaron calificación, la expulsaron o sacaron de la escuela, etc.)?
                    ...
                    <?php echo form_label('16.1) ¿Qué personas de la siguiente lista la han castigado, tratado mal o se han vengado por negarse a tener relaciones sexuales? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="16_1[]" id="16_1">
                    ...
                    <?php echo form_label('16.2) ¿Dónde sucedió que alguien la haya castigado, tratado mal o se haya vengado por negarse a tener relaciones sexuales? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="16_2[]" id="16_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('16.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya castigado, tratado mal o se haya vengado por negarse a tener relaciones sexuales desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="16_3[]" id="16_3">
