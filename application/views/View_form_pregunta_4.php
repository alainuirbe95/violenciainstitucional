              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
          					...
          					<h4 class="mt-4">Pregunta 4 </h4>


                    Durante su vida como estudiante, ¿alguna persona de las escuelas a las que asistió a estudiar, (sea maestra o maestro, director, prefecto, compañero de clases o alumno de la escuela, trabajador o persona de la escuela) le llegó a mostrar sus partes íntimas o se las manoseo (a sí mismo) frente a usted? 
                    ...
                    <?php echo form_label('4.1)  ¿Qué personas de la siguiente lista le han mostrado sus partes íntimas o se las han manoseado frente a usted? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="4_1[]" id="4_1">
                    ...
                    <?php echo form_label('4.2) ¿Dónde sucedió que alguien le haya mostrado sus partes íntimas o se las haya manoseado frente a usted? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="4_2[]" id="4_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('4.3) ¿Con qué frecuencia le ha ocurrido que alguien le haya mostrado sus partes íntimas o se las haya manoseado frente a usted? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="4_3[]" id="4_3">
