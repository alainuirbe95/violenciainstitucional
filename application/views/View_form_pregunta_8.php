              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
                    ...
                    <?php echo form_label('8.1) ¿Qué personas de la siguiente lista la han propuesto o insinuado tener relaciones sexuales a cambio de calificaciones, cosas o beneficios en la escuela? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="8_1[]" id="8_1">
                    ...
                    <?php echo form_label('8.2) ¿Dónde sucedió que alguien la haya propuesto o insinuado tener relaciones sexuales a cambio de calificaciones, cosas o beneficios en la escuela? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="8_2[]" id="8_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('8.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya propuesto o insinuado tener relaciones sexuales a cambio de calificaciones, cosas o beneficios en la escuela desde que ingresó a la escuela? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="8_3[]" id="8_3">
