              ...
              <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-right-tabContent">
                  <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
                    ...
                    <?php echo form_label('6.1) ¿Qué personas de la siguiente lista la han obligado a mirar escenas o actos sexuales o pornográficos (fotos, revistas, videos o películas pornográficas)? (señale las casillas necesarias)'); ?>

                  <select class="select2 " multiple="multiple" data-placeholder="Selecciona una o más opciones" name="6_1[]" id="6_1">
                    ...
                    <?php echo form_label('6.2) ¿Dónde sucedió que alguien la haya obligado a mirar escenas o actos sexuales o pornográficos (fotos, revistas, videos o películas pornográficas)? (señale las casillas necesarias)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="6_2[]" id="6_2">
                    ...
                    <option value="64">Otro</option>
 			    	...
 			    	<div class="form-group forms select2-orange  col-sm-7">
                    <?php echo form_label('6.3) ¿Con qué frecuencia le ha ocurrido que alguien la haya obligado a mirar escenas o actos sexuales o pornográficos (fotos, revistas, videos o películas pornográficas)? (favor de marcar únicamente una casilla)'); ?>

                  <select class="select2" multiple="multiple" data-placeholder="Selecciona una o más opciones" name="6_3[]" id="6_3">
